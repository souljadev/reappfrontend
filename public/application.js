...
var config = {
  apiOrigins: {
    production: 'https://bmcrmapp.herokuapp.com',
...
// handlebar function
var showClients = function showClients(data) {
...
var deleteCUClient = function deleteCUClient(data) {
  return $.ajax({
...
var clientEvents = __webpack_require__(17);
...
var clientAPI = __webpack_require__(7);
var clientUI = __webpack_require__(18);
...
var onCreate = function onCreate(event) {
  var data = getFormFields(this);
  event.preventDefault();
  clientAPI.createClient(data).then(clientUI.onCreateSuccess).catch(clientUI.onCreateFailure);
  this.reset();
  return false;
};
// update client
var onUpdateClient = function onUpdateClient(event) {
  var data = getFormFields(this);
  event.preventDefault();
  clientAPI.updateClient(data).then(clientUI.onUpdateClientSuccess).catch(clientUI.onUpdateClientFailure);
  this.reset();
  return false;
};
// show client
var showClient = function showClient(event) {
  var data = getFormFields(this);
  event.preventDefault();
  clientAPI.showClients(data).then(clientUI.showClientSuccess).catch(clientUI.showClientFailure);
  return data;
};
// delete client
...
var onGetClients = function onGetClients(event) {
  ...
  event.preventDefault();
  clientAPI.showClients().then(clientUI.getClientsSuccess).catch(clientUI.failure);
};

var onGetNames = function onGetNames(event) {
  event.preventDefault();
  clientAPI.showClients().done(clientUI.getNamesSuccess).fail(clientUI.failure);
};
...
var store = __webpack_require__(3);
var clientAPI = __webpack_require__(7);
var showClientsTemplate = __webpack_require__(19);
...
var onUpdateClientSuccess = function onUpdateClientSuccess(data) {
  $('#form-message').text('Updated Client Succesfully');
  $('#getClientsButton').click();
};
// Update Fail
var onUpdateClientFailure = function onUpdateClientFailure() {
  $('#form-message').text('Error on Update');
};
// show Client Successful, reset show client
var showClientSuccess = function showClientSuccess(data) {
  $('#form-message').text('show succesfully');
};
// show Client Fail
var showClientFailure = function showClientFailure() {
...
var getClientsSuccess = function getClientsSuccess(data) {
  ...
  // delete client
  var deleteCurrentClient = function deleteCurrentClient(data) {
    store.id = $(event.target).data('id');
    event.preventDefault();
    clientAPI.deleteCUClient(data).then(deleteSuccess).catch(deleteFailure);
  };
...
module.exports = {
  ...
  onUpdateClientFailure: onUpdateClientFailure,
  showClientSuccess: showClientSuccess,
  showClientFailure: showClientFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "        <div class=\"chld\">\n          <div class=\"del-butts\">\n            <form>\n              <fieldset>\n                <input type=\"submit\" class=\"delete\" name=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" id=\"deletec\" value=\"Delete Client\">\n              </fieldset>\n            <form>\n          </div>\n\n\n\n          <div class=\"handlbiz\" class=\"clearfix\">\n\n            <div class=\"pic-border\" class=\"clearfix\">\n              <img src=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.pic : stack1), depth0))
    + "\" class=\"handleimgz\">\n            </div>\n            <div class=\"profile\">\n              First Name: "
  ...
  return "<div class=\"handlewrapper\">\n"
